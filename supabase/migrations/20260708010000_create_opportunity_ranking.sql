-- Opportunity Ranking: generic daily ranking layer for model prognostics.
-- This is intentionally separate from prognosticos so CONFIRMA_IA and TOP_FINAL
-- can evolve without changing existing validation, publication, or bankroll rules.
