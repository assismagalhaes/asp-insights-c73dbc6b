...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.coletas_odds TO authenticated;
GRANT ALL ON public.coletas_odds TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.odds_jogos TO authenticated;
GRANT ALL ON public.odds_jogos TO service_role;
...
DROP TRIGGER IF EXISTS touch_coletas_odds_updated_at ON public.coletas_odds;
CREATE TRIGGER touch_coletas_odds_updated_at
BEFORE UPDATE ON public.coletas_odds
