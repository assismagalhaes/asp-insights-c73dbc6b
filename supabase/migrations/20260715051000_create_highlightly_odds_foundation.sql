-- Highlightly Phase 2: canonical markets, change-only odds history and consensus.
...
BEGIN
  ...
  -- A deterministic 64-character fingerprint without relying on pgcrypto's
  -- installation schema (which varies between hosted and local Supabase).
