...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      resumos_aprendizado_ia: {
        Row: {
          alertas_recorrentes: Json | null
          aprendizados_por_esporte: Json | null
          aprendizados_por_mercado: Json | null
          created_at: string
          id: string
