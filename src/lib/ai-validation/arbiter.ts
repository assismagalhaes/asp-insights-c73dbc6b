...
function fallbackOutput(reason: string): AiOperationalOutput {
  ...
  return {
    ...
    narrative: {
      evaluated_entry: "Entrada não disponível devido à falha do contrato.",
      thesis_for: "Tese favorável não disponível.",
      thesis_against: "Tese contrária não disponível.",
      internal_history: "Histórico interno não disponível.",
      final_justification: "A saída da IA não pôde ser validada.",
